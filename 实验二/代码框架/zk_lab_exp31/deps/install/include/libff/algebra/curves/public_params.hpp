 ...
 * Some downstream code (e.g., older libsnark headers) expects libff::size_in_bits(v)
 * for vectors of group elements.
 */
template<typename T>
inline std::size_t size_in_bits(const std::vector<T> &v)
{
